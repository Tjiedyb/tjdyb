...
@interface financingViewController ()<WKUIDelegate,WKNavigationDelegate>
{
    WKWebView *webView;
}
@end
...
//    [webView addObserver:self forKeyPath:@"title" options:NSKeyValueObservingOptionNew context:NULL];
     [webView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"http://mobile.htjh.group/Loan/Index?token=%@",[GlobService sharedInstance].model.access_token]]]];
