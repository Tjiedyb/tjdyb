...
@interface InsuranceViewController ()<WKUIDelegate,WKNavigationDelegate>
...
//    [webView addObserver:self forKeyPath:@"title" options:NSKeyValueObservingOptionNew context:NULL];
     [webView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"http://mobile.htjh.group/Lease/Index?token=%@",[GlobService sharedInstance].model.access_token]]]];
